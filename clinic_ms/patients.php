    ...
    <section class="main">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody class="table-group-divider">
                <?php
                    /*if (isset($_GET['date']) && $_GET['date'] != '' && isset($_GET['position']) && $_GET['position'] != ''){
                        //$date = validate($_GET['date']);
                        $patients = mysqli_query($con, "SELECT * from add_patient where date='$date' order by id desc");

                    } else{
                        $patients = mysqli_query($con, "SELECT * from add_patient order by id desc");
                    }*/
