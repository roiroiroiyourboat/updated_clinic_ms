            ...
            <tbody class="table-group-divider">
                <?php
                    ...
                    while($row = $result-> fetch_assoc()){
                        ...
                        <td>
                            <a class='btn btn-primary btn-sm' onclick='openForm()' href='viewuser.php?updateid=$id' target='_parent'><i class='bi bi-eye'></i></a>
                            
                        </td>
                        </tr>"; //<a class='btn btn-danger btn-sm' href='deleteuser.php?deleteuser=$id'><i class='bx bx-trash'></i></a>
                    }
                ?> 
            </tbody> 
        </table>   
